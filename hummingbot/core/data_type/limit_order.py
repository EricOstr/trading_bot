...
from hummingbot.core.cpp.limit_order import CPPLimitOrder
...
class LimitOrder:
    ...
    """
    @classmethod
    def to_pandas(cls, limit_orders: List[Any], mid_price: float = 0.0, hanging_ids: List[str] = None,
        ...
        data = []
        order_id_txt, type_txt, spread_txt, age_txt, hang_txt
        price, quantity
        age_seconds
    ...
    def __init__(self,
        ...
        cpp_trading_pair = trading_pair.encode("utf8")
        cpp_base_currency = base_currency.encode("utf8")
        cpp_quote_currency = quote_currency.encode("utf8")
    ...
    def client_order_id(self) -> str:
        ...
        cpp_client_order_id = self._cpp_limit_order.getClientOrderID()
        retval = cpp_client_order_id.decode("utf8")

        return retval

    @property
    def trading_pair(self) -> str:
        cpp_trading_pair = self._cpp_limit_order.getTradingPair()
        retval = cpp_trading_pair.decode("utf8")
        return retval
    ...
    def base_currency(self) -> str:
        cpp_base_currency = self._cpp_limit_order.getBaseCurrency()
        retval = cpp_base_currency.decode("utf8")
        return retval

    @property
    def quote_currency(self) -> str:
        cpp_quote_currency = self._cpp_limit_order.getQuoteCurrency()
        retval = cpp_quote_currency.decode("utf8")
        return retval

    @property
    def price(self) -> Decimal:
        return self._cpp_limit_order.getPrice()

    @property
    def quantity(self) -> Decimal:
        return self._cpp_limit_order.getQuantity()

    @property
    def filled_quantity(self) -> Decimal:
        return self._cpp_limit_order.getFilledQuantity()
    ...
    def c_age_til(self, end_timestamp):
        """
